...
def test_data_insertion():
    data = [
        {'staff_record_id': 1, 'first_name': 'Jeremie', 'last_name': 'Franey',
         'department_name': 'Purchasing', 'location': 'Manchester',
         'email_address': 'jeremie.franey@terrifictotes.com'}]
    con = Mock()
    mock_datetime = dt(2024, 2, 26, 10, 30, 0)
    wds(con, data, mock_datetime)
...
def test_data_insertion_for_multiple_data():
    data = [
        {'staff_record_id': 1, 'first_name': 'Jeremie', 'last_name': 'Franey',
         'department_name': 'Purchasing', 'location': 'Manchester',
         'email_address': 'jeremie.franey@terrifictotes.com'},
        {'staff_record_id': 2, 'first_name': 'Deron', 'last_name': 'Beier',
         'department_name': 'Facilities', 'location': 'Manchester',
         'email_address': 'deron.beier@terrifictotes.com'},
        {'staff_record_id': 3, 'first_name': 'Jeanette',
         'last_name': 'Erdman', 'department_name': 'Facilities',
         'location': 'Manchester',
         'email_address': 'jeanette.erdman@terrifictotes.com'},
        {'staff_record_id': 4, 'first_name': 'Ana', 'last_name': 'Glover',
         'department_name': 'Production', 'location': 'Leeds',
         'email_address': 'ana.glover@terrifictotes.com'},
        {'staff_record_id': 5, 'first_name': 'Magdalena',
         'last_name': 'Zieme', 'department_name': 'HR',
         'location': 'Leeds',
         'email_address': 'magdalena.zieme@terrifictotes.com'}
    ]
    con = Mock()
